...
extension GameVoyage {
    ...
    @objc func hintTapped(_ sender: UIButton) {
        ...
        // Update button appearance based on hint visibility
        let buttonColor = isHintVisible ? UIColor(red: 0.85, green: 0.65, blue: 0.35, alpha: 1.0) : UIColor(red: 0.95, green: 0.55, blue: 0.25, alpha: 1.0)
    ...
    func resetGame() {
        ...
        UIView.animate(withDuration: 0.3) {
            self.hintButton.backgroundColor = UIColor(red: 0.95, green: 0.55, blue: 0.25, alpha: 1.0)
