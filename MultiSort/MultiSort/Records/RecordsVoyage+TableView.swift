...
class MemorableCell: UITableViewCell {
    ...
    func assembleCell() {
        ...
        NSLayoutConstraint.activate([
            ...
            variantLabel.leadingAnchor.constraint(equalTo: rankLabel.trailingAnchor, constant: 12),
            ...
            timeLabel.leadingAnchor.constraint(equalTo: rankLabel.trailingAnchor, constant: 12),
            
            detailLabel.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: 4),
            detailLabel.leadingAnchor.constraint(equalTo: rankLabel.trailingAnchor, constant: 12),
            
            dateLabel.topAnchor.constraint(equalTo: detailLabel.bottomAnchor, constant: 4),
            dateLabel.leadingAnchor.constraint(equalTo: rankLabel.trailingAnchor, constant: 12),
